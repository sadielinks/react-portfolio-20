        ...
        <footer style={footerStyles} className="footer" id="footer">
            ...
            <div id="footer-icons">
                ...
                <a href="mailto:sadiecodes@gmail.com" target="_blank"><img
                    src="https://img.icons8.com/ios-filled/50/000000/send-mass-email.png" alt='email' className='icon' /></a>
                {/* LinkedIn */}
                <a href="https://www.linkedin.com/in/sadie-sial-bootcamp" target="_blank"><img
                    src="https://img.icons8.com/ios-glyphs/55/000000/linkedin.png" alt="LinkedIn" className="icon" /></a>
                {/* GitHub */}
                <a href="https://github.com/sadielinks" target="_blank"><img src="https://img.icons8.com/ios-glyphs/55/000000/github.png" alt="GitHub" className="icon" /></a>
            </div>
            {/* tagline */}
